...
import { createList, deleteList, getListsByBoard, updateList, restoreList, getArchivedLists } from "../controllers/list.controller.js";
...
router.post("/boards/:boardId/lists/:listId/restore", restoreList);
router.get("/boards/:boardId/lists/archived", getArchivedLists);
